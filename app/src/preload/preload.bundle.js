...
var RendererRouter = /** @class */ (function () {
    ...
    Object.defineProperty(RendererRouter.prototype, "baseModulePath", {
        get: function () {
            return electron_1.ipcRenderer.sendSync('getBaseModulePath');
        },
        enumerable: false,
        configurable: true
    });
    ...
    Object.defineProperty(RendererRouter.prototype, "sharedObject", {
        get: function () {
            return electron_1.ipcRenderer.sendSync('getSharedObject');
        },
        enumerable: false,
        configurable: true
    });
    RendererRouter.prototype.closeAboutWindow = function () {
        electron_1.ipcRenderer.sendSync('closeAboutWindow');
    };
    ...
    RendererRouter.prototype.canShowCustomButton = function () {
        return electron_1.ipcRenderer.sendSync('canShowCustomButton');
    };
    RendererRouter.prototype.customButtonClicked = function (key) {
        electron_1.ipcRenderer.send('customButtonClicked', key);
    };
